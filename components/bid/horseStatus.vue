<template>
  <div v-if="status" class="inline">
    <div
      v-if="status == 'PREBID'"
      class="bg-yellow-400 text-white rounded-full sm:px-5 py-1 text-[10px] md:text-sm text-center w-38 whitespace-nowrap uppercase"
    >
    ...
    <div
      ...
      class="text-white rounded-full px-2 sm:px-5 py-1 text-[10px] md:text-sm bg-[#B8BB2A] text-center w-38 md:whitespace-nowrap uppercase"
    >
