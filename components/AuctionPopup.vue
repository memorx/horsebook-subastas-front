<template>
  <div v-if="showPopup" class="fixed inset-0 z-[9999] flex items-center justify-center p-4">
    ...
    <div class="relative w-full max-w-6xl mx-auto bg-white rounded-lg p-6 md:p-8">
      ...
      <a 
        :href="config.url"
        class="block w-full bg-green-700 hover:bg-green-800 text-white text-center font-bold py-4 px-6 rounded-full text-lg md:text-xl transition duration-300 shadow-lg"
      >
