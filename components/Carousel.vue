<template>
    ...
    >
        ...
        >
            <iframe
                v-if="currentImage !== null && typeof currentImage === 'object'"
                class="rounded-lg absolute inset-0 w-full h-full object-cover"
                :src="
                    currentImage.video_url
                ...
                allowfullscreen
                @click="toggleEnlargeImage(currentImage)"
                >
            </iframe>
            <img
...
export default {
    ...
    methods: {
        ...
        toggleEnlargeImage() {
            if (this.enlargedImageIndex === null) {
    ...
    computed: {
        ...
        isImageEnlarged() {
            return this.enlargedImageIndex !== null && this.enlargedImageIndex === this.currentImageIndex;
        }
    }
}
</script>
