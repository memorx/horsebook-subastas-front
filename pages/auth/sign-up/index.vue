                    ...
                    <div class="flex flex-col w-full gap-6">
                        ...
                        <div class="flex flex-col w-full ">
                            <label for="identification_document"
                                class="titleInput font-medium text-base text-black">Documento de identidad
                                (ID/Pasaporte)</label>
                    ...
                    <div class="flex justify-center w-full mt-6 pb-2 signUp">
                        <div class="flex flex-col items-center signUpp">
                            <p class="signUppp font-normal text-base text-neutral-600">¿Ya tienes cuenta? <nuxt-link
                                    to="/auth/login" class="font-medium text-base text-black">Inicia sesión</nuxt-link></p>
                        </div>
                    </div>
                </form>
            </div>
